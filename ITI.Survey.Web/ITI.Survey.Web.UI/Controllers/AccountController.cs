...
namespace ITI.Survey.Web.UI.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            //if (HttpContext.Request.Browser.IsMobileDevice || fBrowserIsMobile())
        ...
        public bool fBrowserIsMobile()
        {
            ...
            if (HttpContext.Request != null && HttpContext.Request.ServerVariables["HTTP_USER_AGENT"] != null)
            {
                var u = HttpContext.Request.ServerVariables["HTTP_USER_AGENT"].ToString();
        ...
        public ActionResult LogOff()
        {
            ...
            //if (BE.LoginSession.GetLoginSession(userLogin, ipAddress) != null) BE.LoginSession.DeleteLoginSessionByUserLogin(userLogin);
